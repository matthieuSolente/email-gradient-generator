...
(function($) {
  ...
  function updateValues() {
    ...
    generatePreview = '\n' +
      ...
      '        <v:textbox inset="' + containerLrPadding + ',' + containerTbPadding + ',' + containerLrPadding + ',' + containerLrPadding + '" style="mso-fit-shape-to-text:'+fitShape+'">\n' +
      '          <![endif]-->\n' +
      '          ' + htmlDecode(text) + '\n' +
      '          ' + htmlDecode(image) + '\n' +
      '        <!--[if mso]>\n' +
